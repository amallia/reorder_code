...
namespace CONSTS {
	...
	//######dodo########
	const std::string ikQuery("/home/qw376/CIKM2017/queryFiles/1kRawQueries"); //1k_trec05; //1000query

	// const std::string trecRoot("/home/qw376/CIKM2017/smallIndexSystem/");
	// const std::string doclenFileName("/home/qw376/Info_Clueweb/documentLengths"); //doc lengths
	// const std::string basic_table("/home/qw376/CIKM2017/lexFiles/1kQueriesLex406Uniq");
	// const std::string fResultLog("/home/qw376/CIKM2017/queryResult/system10");

	// const std::string trecRoot("/home/qw376/CIKM2017/smallIndexRandom/");
	// const std::string doclenFileName("/home/qw376/CIKM2017/docLengthFiles/randomDocLength");
...
// ("/data1/Indexing/index" + std::string(EXPECTED_BLOCKSIZE) + "/");
	...
	// const std::string doclenFileName("/home/ubuntu/million9_query_trace/documentLengths"); // /data/sding/TwoLevelTrec/index_result/doclen_file or doclen_file_sorted

	const std::string sqlPath(trecRoot+"indx.sqlite");
	// const std::string basic_table("/home/ubuntu/million9_query_trace/baby_lexicon_m09_all"); 
